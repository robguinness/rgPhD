...
\thesistype{Licentiate of Science thesis} % or Bachelor of Science, Laboratory Report... 
\examiner{Jarmo Takala} % without title Prof., Dr., MSc or such
...
%
% Add the  of contents, optionally also the lists of figures,
% tables and codes.
%
...
\chapter{Overview of Context Awareness}
\label{ch:overview}
...
\chapter{Smartphone User Contexts}
\label{sec:smartphone_users}
...
\chapter{Maritime User Contexts}
\label{sec:maritime_users}
